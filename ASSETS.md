...
The original pilot art and the Space Arcade soundtrack are published in the public [`assets` branch](https://github.com/sbanjoe25/tobi-flap/tree/assets/media). This keeps the deployable `main` branch lightweight while providing stable public downloads for the project media.
...
> **Rights note:** These project media files are made available for use with Tobi Flap. Do not redistribute pilot photographs or soundtrack material outside the project without authorization from the rights holder.
